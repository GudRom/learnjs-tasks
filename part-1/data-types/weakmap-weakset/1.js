...
// вы могли бы использовать для ответа на вопрос «было ли сообщение прочитано?».
...
// Ответ: можно воспользоваться WeakSet, добавляя туда прочитанные сообщения. 
// При запросе прочитано сообщение или нет, мы могли бы легко проверит,
// есть ли это сообщение в нашей коллекции.