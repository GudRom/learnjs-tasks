...
// Например, при запросе (fetch) http://google.com с http://javascript.info/some/url 
...
// Потому что Origin является обязательным заголовком, а Referer может не быть.

// Возможно ли отсутствие Referer или Origin, или это неправильно?
// Referer является необязательным, а без Origin не обойтись. 